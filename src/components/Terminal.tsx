...
export const commands: Command = [
  { cmd: "about", desc: "about Nikhil Singh", tab: 8 },
  { cmd: "cat", desc: "display file contents", tab: 10 },
  { cmd: "clear", desc: "clear the terminal", tab: 8 },
  { cmd: "echo", desc: "print out anything", tab: 9 },
  { cmd: "education", desc: "my education background", tab: 4 },
  { cmd: "email", desc: "send an email to me", tab: 8 },
  { cmd: "get", desc: "download files (pdf)", tab: 10 },
  { cmd: "gui", desc: "go to my portfolio in GUI", tab: 10 },
  { cmd: "help", desc: "check available commands", tab: 9 },
  { cmd: "history", desc: "view command history", tab: 6 },
  { cmd: "ls", desc: "list available files", tab: 10 },
  { cmd: "projects", desc: "view projects that I've coded", tab: 5 },
  { cmd: "set", desc: "set theme (set <theme>)", tab: 10 },
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    ...
    if (e.key === "Tab" || ctrlI) {
      ...
      // if only one command to autocomplete
        ...
        // For multi-word commands, replace the last incomplete word
        if (currentCmd.length > 1) {
          currentCmd[currentCmd.length - 1] = hintsCmds[0];
          setInputVal(currentCmd.join(" "));
        } else {
          ...
          <div key={_.uniqueId(`${cmdH}_`)}>
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: "0.9rem", paddingLeft: "0.15rem" }}
              >
                {cmdH}
              </span>
            </div>
